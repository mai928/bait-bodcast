                    ...
                    </>
                    {
                        sliderData.map((slide, index) => (
                            <SwiperSlide key={index} className="swiper-slide">
                                ...
                                <div key={index} className='absolute top-10 lg:top-28 start-7  lg:start-[10%]  lg:w-[60%]'>
                                    ...
                                    <div className='mt-10 lg:mt-6 mb-10 text-white   text-[16px] lg:text-[19px]  font-semibold lg:font-bold ' dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize((slide?.details)) }} />
